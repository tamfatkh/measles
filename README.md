...
Put all of the files in the same folder. Use the Python Jupyter notebook to run the code. Make sure to use the correct path to the folder at the beginning of the code.
